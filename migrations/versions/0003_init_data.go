...
func InitPermissions() []models.Permission {
	...
	p1 := models.Permission{ID: 2, Name: "权限管理", MenuName: "权限管理", Route: "/admin", Identify: "/admin", Type: 1, ParentID: 1, Index: 0}
	p2 := models.Permission{ID: 3, Name: "操作日志", MenuName: "操作日志", Route: "/admin/log", Identify: "/admin/log", Type: 1, ParentID: 2, Index: 0}
	p3 := models.Permission{ID: 4, Name: "权限规则", MenuName: "权限规则", Route: "/admin/permission", Identify: "/admin/permission", Type: 1, ParentID: 2, Index: 0}
	...
	p5add := models.Permission{ID: 79, Name: "权限规则编辑", MenuName: "权限规则编辑", Route: "admin.adminpermission.update", Identify: "admin.adminpermission.update", Type: 0, ParentID: 4, Index: 0}
	...
	p8 := models.Permission{ID: 9, Name: "管理组", ParentID: 2, MenuName: "管理组", Route: "/admin/group", Identify: "/admin/group", Type: 1, Index: 0}
	...
	p14 := models.Permission{ID: 15, Name: "管理员", ParentID: 2, MenuName: "管理员", Route: "/admin/user", Identify: "/admin/user", Type: 1, Index: 0}
	p14add1 := models.Permission{ID: 80, Name: "JS分类权限", ParentID: 15, MenuName: "JS分类权限", Route: "admin.admin.js.auth", Identify: "admin.admin.js.auth", Type: 0, Index: 0}
	p14add2 := models.Permission{ID: 81, Name: "角色分类", ParentID: 15, MenuName: "角色分类", Route: "admin.admin.role.set", Identify: "admin.admin.role.set", Type: 0, Index: 0}
	...
	p20 := models.Permission{ID: 21, Name: "数据统计", ParentID: 1, MenuName: "数据统计", Route: "/data", Identify: "/data", Type: 1, Index: 0}
	p21 := models.Permission{ID: 22, Name: "流量统计", ParentID: 21, MenuName: "流量统计", Route: "/data/flow", Identify: "/data/flow", Type: 1, Index: 0}
	...
	p25 := models.Permission{ID: 26, Name: "来路统计", ParentID: 21, MenuName: "来路统计", Route: "/data/from", Identify: "/data/from", Type: 1, Index: 0}
	...
	p28 := models.Permission{ID: 29, Name: "应用管理", ParentID: 1, MenuName: "应用管理", Route: "/application", Identify: "/application", Type: 1, Index: 0}
	p29 := models.Permission{ID: 30, Name: "CDN白名单", ParentID: 29, MenuName: "CDN白名单", Route: "/application/cdn-white", Identify: "/application/cdn-white", Type: 1, Index: 0}
	...
	p35 := models.Permission{ID: 36, Name: "IP白名单", ParentID: 29, MenuName: "IP白名单", Route: "/application/ip-white", Identify: "/application/ip-white", Type: 1, Index: 0}
	...
	p41 := models.Permission{ID: 42, Name: "IP库管理", ParentID: 29, MenuName: "IP库管理", Route: "/application/ip", Identify: "/application/ip", Type: 1, Index: 0}
	...
	p47 := models.Permission{ID: 48, Name: "域名管理", ParentID: 29, MenuName: "域名管理", Route: "/application/js-domain", Identify: "/application/js-domain", Type: 1, Index: 0}
	...
	p53 := models.Permission{ID: 54, Name: "JS分类", ParentID: 29, MenuName: "JS分类", Route: "/application/js-class", Identify: "/application/js-class", Type: 1, Index: 0}
	...
	p55 := models.Permission{ID: 56, Name: "JS分类列表", ParentID: 54, MenuName: "JS分类列表", Route: "admin.category.index", Identify: "admin.category.index", Type: 0, Index: 0}
	p56 := models.Permission{ID: 57, Name: "JS分类详情", ParentID: 54, MenuName: "JS分类详情", Route: "admin.category.show", Identify: "admin.category.show", Type: 0, Index: 0}
	p57 := models.Permission{ID: 58, Name: "JS分类删除", ParentID: 54, MenuName: "JS分类删除", Route: "admin.category.destroy", Identify: "admin.category.destroy", Type: 0, Index: 0}
	p58 := models.Permission{ID: 59, Name: "JS分类编辑", ParentID: 54, MenuName: "JS分类编辑", Route: "admin.category.update", Identify: "admin.category.update", Type: 0, Index: 0}
	p59 := models.Permission{ID: 60, Name: "JS分类新建", ParentID: 54, MenuName: "JS分类新建", Route: "admin.category.create", Identify: "admin.category.create", Type: 0, Index: 0}
	p60 := models.Permission{ID: 61, Name: "JS管理", ParentID: 29, MenuName: "JS管理", Route: "/application/js", Identify: "/application/js", Type: 1, Index: 0}
	...
	p75 := models.Permission{ID: 76, Name: "主页", ParentID: 1, MenuName: "主页", Route: "/dashboard", Identify: "/dashboard", Type: 1, Index: 0}
	...
	return []models.Permission{p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19,
		...
		p64, p65, p66, p67, p68, p69, p70, p71, p72, p73, p74, p75, p76, p77, p5add, p14add1, p14add2}
}
...
// V0003InitProjectData init project data
var V0003InitProjectData = &gormigrate.Migration{
	ID: "0003_init_project_data",
	Migrate: func(tx *gorm.DB) error {
		if err := tx.Create(InitPermissions()).Error; err != nil {
			return err
		}
