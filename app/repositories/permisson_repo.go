...
type PermissionRepo interface {
	...
	Get(db *gorm.DB, id int64) (*models.Permission, exception.Exception)
	...
	Delete(db *gorm.DB, ids []int64) exception.Exception
}
...
func (u *PermissionRepoImpl) Get(db *gorm.DB, id int64) (*models.Permission, exception.Exception) {
	p := models.Permission{}
...
func (u *PermissionRepoImpl) Update(db *gorm.DB, id int64, param map[string]interface{}) exception.Exception {
...
func (u *PermissionRepoImpl) Delete(db *gorm.DB, ids []int64) exception.Exception {
