...
type RmService interface {
	...
	Get(id uint) (*vo.RedirectManageResp, exception.Exception)
	List(page *vo.PageInfo) (*vo.DataPagination, exception.Exception)
	Update(openID string, id uint, param *vo.RedirectManageUpdateReq) exception.Exception
...
func (rsi *rmServiceImpl) Get(id uint) (*vo.RedirectManageResp, exception.Exception) {
...
func (rsi *rmServiceImpl) Update(openID string, id uint, param *vo.RedirectManageUpdateReq) exception.Exception {
	return rsi.repo.Update(rsi.db, id, param.ToMap(openID))
}

func (rsi *rmServiceImpl) Delete(id uint) exception.Exception {
