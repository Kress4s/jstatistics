...
type RedirectLog struct {
	...
	OldPC      string    `gorm:"column:old_pc;type:varchar(50);comment:原pc跳转地址"`
	OldAndroid string    `gorm:"column:old_android;type:varchar(50);comment:原android跳转地址"`
	OldIOS     string    `gorm:"column:old_ios;type:varchar(50);comment:原ios跳转地址"`
	PC         string    `gorm:"column:pc;type:varchar(50);not null;comment:pc跳转地址"`
	IOS        string    `gorm:"column:ios;type:varchar(50);not null;comment:ios跳转地址"`
